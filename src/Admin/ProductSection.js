...
import { fetchProducts, addProduct, editProduct, deleteProduct } from "../Features/adminSlice";
...
const AdminProductManagement = () => {
  ...
  const filteredProducts = selectedCategory
    ? products.filter((product) => product.category.trim().toLowerCase() === selectedCategory)
    : products;
...
const handleDeleteClick = (id, category) => {
  ...
  return (
    <div className="p-6 bg-gray-100 mt-4 min-h-screen">
          ...
          >
            ...
            <div className="flex space-x-4 mt-4 sm:mt-0">
              ...
              <button
                ...
                onClick={() =>
                  handleDeleteClick(product.id, product.category)
                } // Handle deletion
              >
                Delete
              </button>
