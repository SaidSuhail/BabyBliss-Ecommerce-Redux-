...
//       <div
//         key={item.id}
//         className="cart-item flex flex-wrap md:flex-nowrap items-center justify-between bg-white p-4 shadow rounded mb-4"
//       >
//         <div className="cart-item-info flex flex-wrap md:flex-nowrap items-center w-full md:w-auto">
//           <img
//             src={item.image}
//             alt={item.name}
...
//           </div>
//         </div>
//         <div className="cart-item-controls flex items-center space-x-4 mt-4 md:mt-0">
//           <button
//             onClick={() => dispatch(decreaseQuantity(item.id))}
//             className="bg-gray-200 text-gray-800 px-3 py-1 rounded"
//             disabled={item.quantity <= 1}
...
//       Total: ₹{cart.reduce((acc, item) => acc + item.price * item.quantity, 0)}
//     </h3>
//     <div className="cart-actions mt-4 flex flex-col md:flex-row space-y-2 md:space-y-0 md:space-x-4">
//       <button
//         onClick={() => dispatch(clearCart())}
//         className="bg-gray-500 text-white px-4 py-2 rounded"
//       >
